...
const Onboarding3 = () => {
  return (
    <View style={styles.onboarding3}>
      <Text style={[styles.getStartedOn, styles.getStartedOnTypo]}>
        Get started on Ordering your Food
      </Text>
      <Text style={[styles.pleaseCreateAn, styles.pleaseCreateAnClr]}>
        Please create an account or sign in to your existing account to start
        browsing our selection of delicious meals from your favorite
        restaurants.
      </Text>
      <View style={styles.onboarding3Child} />
      <View style={[styles.onboarding3Item, styles.onboarding3Layout]} />
      <View style={[styles.onboarding3Inner, styles.onboarding3Layout]} />
      <View style={[styles.rectangleView, styles.timeLightPosition]} />
      <Text style={[styles.illustrationHere, styles.skipTypo]}>
        ILLUSTRATION HERE
      </Text>
      ...
      <View style={[styles.frameView, styles.frameViewFlexBox]}>
        <View style={styles.frameViewFlexBox}>
          <Text style={[styles.continue, styles.skipTypo]}>Continue</Text>
          <Image
      ...
      <View style={[styles.onboarding3Inner1, styles.frameViewFlexBox]}>
        <View style={styles.frameViewFlexBox}>
